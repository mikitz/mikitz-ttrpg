...
function makeToast(content, type){
    ...
    if (type == 'warning') icon = '/encounter-generator/data/icons/triangle-exclamation-solid.svg'
    if (type == 'error') icon = '/encounter-generator/data/icons/circle-xmark-solid.svg'
