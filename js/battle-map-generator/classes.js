...
class Tile {
    constructor(coords, classification, elevation, type, imageName, color, coverTier) {
        this._id = genId()
        this.c = coords // [x,y,z]
...
class BattleMap {
    constructor(name, tileData, ppi, width, height, biome, plane, gridType, hexOrientation, climate, season, seed) {
        this._id = genId()
        this.name = name
        this.td = tileData 
        this.dt = new Date()
